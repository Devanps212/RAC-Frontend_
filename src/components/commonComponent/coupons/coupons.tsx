            ...
            <div className="coupon-codes mt-5">
                ...
                <div className="d-flex justify-content-center align-items-center">
                    {coupons && coupons.length > 0 ? (
                        coupons.map((coupon) => (
                            <div className={`coupon ${coupon.couponUsed ? 'dull' : ''}`} key={coupon._id}>
                                {coupon.couponUsed && (
                                    <div className="coupon-used-banner">
                                        Coupon Used
                                    </div>
                                )}
                                <div className="row align-items-center">
                                    <div className="col-3">
                                        <div className="left-coupon">
                                            <span className="percentage">
                                                {Math.floor(parseFloat(coupon.discountData.percentage.slice(0, -1)))}%
                                            </span>
                                        </div>
                                    </div>
                                    <div className="col-7">
                                    ...
                                    <div className="col-2">
                                        <Button 
                                            className="copy-btn" 
                                            onClick={() => handleCopy(coupon.coupon)} 
                                            disabled={coupon.couponUsed}
                                        >
                                            <FaCopy />
                                        </Button>
                                    </div>
