    ...
    return (
        <div className="table-body">
            ...
            <Table responsive striped hover className="custom-table">
                ...
                <tbody>
                    {Array.isArray(AllBooking) && AllBooking.length > 0 && AllBooking.map((booking: detailBooking, index: number) => (
                        <tr key={index}>
                            <td>{index + 1}</td>
                            ...
                            <td>
                                ...
                                {' '}
                                <Button className="mt-1" onClick={() => showTheModal(booking._id)} variant="success" size="sm" style={{ width: "54%" }}>
                                    <FaInfoCircle /> Info
                                </Button>
                            </td>
                        </tr>
                    ...
                    {AllBooking && !Array.isArray(AllBooking) && (
                        <tr>
                            ...
                            <td>
                                ...
                                {' '}
                                <Button className="mt-1" onClick={() => showTheModal(AllBooking._id)} variant="success" size="sm" style={{ width: "54%" }}>
                                    <FaInfoCircle /> Info
                                </Button>
                            </td>
                        </tr>
