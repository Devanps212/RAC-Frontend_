...
const TransactionPage = () => {
  ...
  return (
    <div className="Container d-flex flex-column justify-content-center align-items-center" style={{ minHeight: '100vh', backgroundColor: '#eee', paddingTop: '10rem' }}>
      ...
      <h3 className="text-center mb-3">Transaction Successful</h3>
      ...
      <button className="login-success-button">Login</button>
    </div>
  );
};
